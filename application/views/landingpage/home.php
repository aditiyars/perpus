...
<body>
  <div class="container">
    <nav class="navbar bg-color-three">
      <div class="brand">
        <h1 class="brand-title">Perpustakaan Daerah</h1>
      </div>
      <div class="nav-list">
        <ul class="nav-items">
    ...
    <main>
      ...
      <section class="main-section" id="top-book">
        <h1 class="section-title">Most Popular Book</h1>
        <div class="card-collections bg-color-one">
          <div class="card">
      ...
      <section class="main-section" id="banner-motivation">
        <div class="banner-motivation">
          <h2 style="text-align:center;">"membaca adalah koentji"</h2>
        </div>
      </section>
    </main>
